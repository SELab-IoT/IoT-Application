...
public class BluetoothPEPListAdapter extends RecyclerView.Adapter<BluetoothPEPListAdapter.ViewHolder> {
    ...
    public BluetoothPEPListAdapter(List<Map<String, String>> dataSet){
    ...
    @Override
    public BluetoothPEPListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
